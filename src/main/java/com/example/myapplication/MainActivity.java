    ...
    public void onClick(View v) {
        ...
        switch(v.getId()){
            ...
            case R.id.btn_p:
                ...
                if((str.contains(".")&&(!str.contains("+")&&!str.contains("-")&&!str.contains("×")&&!str.contains("÷")))||str.charAt(str.length()-1)=='+'||str.charAt(str.length()-1)=='-'||str.charAt(str.length()-1)=='×'||str.charAt(str.length()-1)=='÷'||str.charAt(str.length()-1)=='.'){
            ...
            case R.id.btn_equ:
                if(str.charAt(0)=='-'){
                    ...
                    Toast.makeText(MainActivity.this,"cann't do it",Toast.LENGTH_SHORT).show();
                    text.setText("0");
                }
